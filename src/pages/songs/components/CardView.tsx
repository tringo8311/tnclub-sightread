...
export default function CardView({ rows, search, levelFilter, onSelectRow }: CardViewProps) {
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 mb-4">
                  ...
                  <p className="text-sm text-gray-500 mt-1 line-clamp-1">{item.category || 'No Category'}</p>
                </div>
